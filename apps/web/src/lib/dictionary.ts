...
const en = {
  ...
  "nav.signOutError": "Sign out failed — check your connection and retry.",
  ...
  "productList.checkError": "Failed to run the price check.",
  "productList.updateError": "Failed to update the product.",
  ...
  "adminSettings.clearTokenConfirm": "Clear the stored Telegram bot token? Alerts will be skipped until a new token is set.",
  ...
  "editForm.updateError": "Failed to update the product.",
  ...
  "detail.checkError": "Failed to run the price check.",
...
const zh: Dictionary = {
  ...
  "nav.signOut": "退出登录",
  "nav.signingOut": "退出中…",
  "nav.signOutError": "退出失败 —— 请检查网络后重试。",
  ...
  "productList.checkError": "执行价格检查失败。",
  "productList.updateError": "更新商品失败。",
  ...
  "adminSettings.clearToken": "清除令牌",
  "adminSettings.clearTokenConfirm": "清除已存储的 Telegram 机器人令牌？在设置新令牌前提醒将被跳过。",
